...
function getOverallResult() {
  ...
  overallInfo += "<tr><th class=\"col-md-1\">appid</th><td class=\"col-md-4\">" + utg.appid + "</td></tr>\n";
  overallInfo += "<tr><th class=\"col-md-1\">crash_flag</th><td class=\"col-md-4\">" + utg.crash_flag + "</td></tr>\n";
  let crash_info = utg.crash_info.replace(/\n/g, '<br>')
  overallInfo += "<tr><th class=\"col-md-1\">crash_info</th><td class=\"col-md-4\">" + crash_info + "</td></tr>\n";
...
function getEdgeDetails(edgeId) {
  ...
  var i;
  edgeInfo += "<tr><th>path_id</th><th>path_trigger</th><th>bound</th><th>view</th></tr>\n"
  
    path = selectedEdge.path;
    
    var viewImg = "";
    if (path.view_images != null) {
      viewImg ="<img class=\"viewImg\" src=\"" + path.view_images + "\"  alt=\"没有图片\">\n"
      // viewImg = path.view_images
       
    }
    edgeInfo += "<tr><td>" + path.path_id + "</td><td>" + path.path_trigger + "</td><td>"+path.bound+ "</td><td>"+ viewImg + "</td></tr>"
  edgeInfo += "</table>\n"
  return edgeInfo;
}
